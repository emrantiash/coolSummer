...
function ToolbarPlugin() {
  ...
  return (
    <div className="flex items-center gap-0.5 bg-gray-200 p-2" ref={toolbarRef}>
...
export default function TextEditor() {
  return (
    <LexicalComposer initialConfig={editorConfig}>
      <div className="relative mx-auto overflow-hidden my-5 w-full rounded-xl border border-gray-400 bg-gray-300 text-left font-normal leading-5 text-gray-900">
        <ToolbarPlugin />
        <div className="relative rounded-b-lg border-opacity-5 bg-gray-100">
          <RichTextPlugin
            contentEditable={
